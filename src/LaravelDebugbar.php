...
class LaravelDebugbar extends DebugBar
{
    ...
    public function isStorageOpen(Request $request): bool
    {
        ...
        if ($this->storageOpen === null) {
            ...
            $this->storageOpen = self::isPrivateIp($request->getClientIp());
        }
     ...
     */
    private static function isPrivateIp(string $requestIp): bool
    {
        if (method_exists(IpUtils::class, 'isPrivateIp')) { // @phpstan-ignore function.alreadyNarrowedType
